...
def prepare_input(pdbname, receptor_chain, target_residues, outdir):
    ...
    # Write receptor for vis - NOW CREATES A UNIQUE FILE PER CHAIN
    receptor_filename = outdir + f'{receptor_chain}_target.pdb'
    write_pdb(receptor_pdb, receptor_chain, receptor_filename)
    ...
    # Write receptor target residues for vis - NOW CREATES A UNIQUE FILE PER CHAIN
    residues_filename = outdir + f'{receptor_chain}_residues.pdb'
    write_pdb(target_residue_pdb, receptor_chain, residues_filename)
