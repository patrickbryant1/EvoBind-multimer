...
def optimise_binder(
    target_1_fasta: str,
    target_2_fasta: str,
    target_1_if_residues: np.array,
    target_2_if_residues: np.array,
    peptide_length: int,
    output_dir: str,
  ...
  7. Return to step 4.
  """
  output_dir = os.path.join(output_dir, 'design')
  ...
  if len(sequence_scores['if_dist_peptide_t1'])<1:
      ...
      save_design(unrelaxed_protein, output_dir, 'start', l1, l2)
  ...
  for num_iter in range(len(sequence_scores['if_dist_peptide_t1']), num_iterations):
    ...
    save_df.to_csv(metrics, index=None)

    save_design(unrelaxed_protein, output_dir, str(num_iter), l1, l2)


######################MAIN###########################
def main(target_1_fasta, target_2_fasta, target_1_if_residues, target_2_if_residues,
        MSAs, peptide_length,
  ...
  optimise_binder(
        target_1_fasta=target_1_fasta,
        target_2_fasta=target_2_fasta,
        target_1_if_residues=target_1_if_residues,
        target_2_if_residues=target_2_if_residues,
